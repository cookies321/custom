...
public class ValidateUtils {
  ...
  public static void main(String[] args) {
    String content =
        "<img src='localhost:8080/test.jpg'></img><img src='localhost:8080/test.jpg'></img>";
    // String content = "<img src='localhost:8080/test.jpg@600w_1l'></img>";
    // List<String> imgStr = ValidateUtils.getImgStr(content);
    content = StringUtils.replace(content, "jpg", "jpg@600w_1l");
